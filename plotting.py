...
if __name__ == "__main__":
    ...
    for i, df in enumerate(dfs_oa):
        ...
        axs[0][0].set_ylabel("OA ($\mu g$/${m^3})$")
        axs[0][0].set_xlabel("BC ($\mu g$/${m^3}$)")
        axs[0][1].set_title("b)", loc='left')
        axs[0][1].set_ylabel("OA ($\mu g$/${m^3})$")
        axs[0][1].set_xlabel("BC ($\mu g$/${m^3}$)")
        axs[0][0].legend()
        ...
        axs[2][0].set_ylabel("OA ($\mu g$/${m^3})$")
        axs[2][0].set_xlabel("CO (ppmv)")
        axs[2][1].set_title("f)", loc='left')
        axs[2][1].set_ylabel("OA ($\mu g$/${m^3})$")
    ...
    for i, df in enumerate(dfs_all):
        ...
        axs[1][0].set_ylabel("BC ($\mu g$/${m^3}$)")
        axs[1][1].set_ylabel("BC ($\mu g$/${m^3}$)")
